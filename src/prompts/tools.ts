...
*   **VIRTUAL FILESYSTEM:**
    ...
    *   Use the \`writeFile\` tool to save text content (like research notes) to a file.
...
*   \`writeFile(path: string, content: string)\`
    *   **Use Case:** Saves text content to a new file in the virtual filesystem. Essential for creating notes from research, saving code snippets for later use, or storing summaries of information gathered.
    *   **Example:** After performing a search, you can save key findings: \`writeFile(path: "/main/output/research_notes.md", content: "# Research Summary\\n- Finding 1...")\`.
