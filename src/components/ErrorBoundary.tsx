...
// Fix: Use React.Component explicitly to ensure props and setState are inherited correctly
export class ErrorBoundary extends React.Component<Props, State> {
  ...
  // Fix: Use React.ErrorInfo for proper typing
  ...
  public render() {
    if (this.state.hasError) {
      // Fix: Access props through the component instance
      ...
      return (
        <div className="flex flex-col items-center justify-center p-8 m-4 bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800/50 rounded-2xl text-center shadow-sm">
          ...
          <div className="flex gap-3">
              <button
                // Fix: Access setState through the React.Component instance
    ...
    // Fix: Access children through the component instance's props
