...
export const MarkdownComponents = {
    ...
    p: (props: any) => React.createElement('p', { className: "mb-4 leading-relaxed text-slate-800 dark:text-slate-300 break-words", ...props }),
...
export const WorkflowMarkdownComponents = {
    ...
    p: (props: any) => React.createElement('p', { className: "mb-2 leading-normal break-words", ...props }),
