...
const CATEGORIES = [
  ...
  { id: 'appearance', label: 'Appearance', icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M10 3.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM6.75 3.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM13.25 3.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM10 8.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM13.25 8.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM6.75 8.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM10 13.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM13.25 13.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM6.75 13.75a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z" /></svg> },
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-ui-100 rounded-2xl shadow-xl w-full max-w-4xl h-[80vh] border border-color flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b border-color flex-shrink-0">
              <h2 id="settings-title" className="text-lg font-bold text-text-primary">
                Settings
              </h2>
              <button
                onClick={onClose}
                className="p-1 rounded-full text-text-muted hover:bg-ui-200"
            ...
            <div className="flex-1 flex min-h-0">
                {/* Left Navigation */}
                <nav className="w-56 flex-shrink-0 p-4 border-r border-color overflow-y-auto">
                ...
                <div className="flex-1 p-6 overflow-y-auto">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {activeCategory === 'general' && <GeneralSettings onClearAllChats={props.onClearAllChats} />}
                            {activeCategory === 'appearance' && <ThemeSettings activeTheme={props.colorTheme} onThemeChange={props.setColorTheme} />}
