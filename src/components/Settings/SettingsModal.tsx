      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="glassmorphic rounded-2xl w-full max-w-4xl h-[80vh] flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b border-[color:var(--surface-border)] flex-shrink-0">
              <h2 id="settings-title" className="text-lg font-bold text-[color:var(--text-primary)]">
                Settings
              </h2>
              <button
                onClick={onClose}
                className="p-1 rounded-full text-[color:var(--text-secondary)] hover:bg-black/5 dark:hover:bg-white/5"
            ...
            <div className="flex-1 flex min-h-0">
                {/* Left Navigation */}
                <nav className="w-56 flex-shrink-0 p-4 border-r border-[color:var(--surface-border)] overflow-y-auto">
