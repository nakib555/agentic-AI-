        ...
        <div className="space-y-8">
            ...
            <SettingField label="Max Output Tokens" description="Set a limit on the number of tokens per model response. Leave at 0 to use the model's default.">
                <input
                    ...
                    className="w-full max-w-xs p-2 border border-slate-200/80 dark:border-white/10 rounded-lg shadow-sm bg-white/60 dark:bg-black/20 text-base focus:outline-none focus:ring-2 focus:ring-indigo-400"
                    disabled={disabled}
                />
            </SettingField>
        </div>
