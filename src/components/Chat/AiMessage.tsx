...
const TtsButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className="group flex items-center gap-2 self-start mt-2 px-2 py-1 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md transition-colors text-xs font-medium disabled:opacity-60 disabled:cursor-wait"
      title={getTitle()}
      disabled={isLoading}
    >
      {getButtonContent()}
