        ...
        <AnimatePresence>
            {hasFiles && (
                <motion.div
                    ...
                    className="flex flex-nowrap overflow-x-auto gap-3 px-4 pb-3 pt-5 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-black/20 scrollbar-hide"
                    onWheel={(e) => {
                        if (e.deltaY !== 0) {
