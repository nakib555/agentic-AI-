            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className={`fixed inset-0 z-[60] bg-black/60 backdrop-blur-sm transition-opacity ${isDesktop ? 'bg-black/30' : ''}`}
                    />
                    ...
                    >
                        ...
                        {/* Header */}
                        <div className={`flex items-center justify-between px-5 py-4 border-b border-border-subtle bg-layer-2 flex-shrink-0 ${!isDesktop ? 'pt-2' : ''}`}>
                        ...
                        {/* Content Viewer */}
                        <div className="flex-1 overflow-auto bg-layer-1 flex flex-col relative">
