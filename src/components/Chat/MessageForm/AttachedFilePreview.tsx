    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="absolute -top-2 -right-2 bg-white dark:bg-[#202020] text-gray-400 hover:text-red-500 dark:hover:text-red-400 rounded-full p-0.5 border border-gray-200 dark:border-white/10 shadow-sm opacity-0 group-hover:opacity-100 transition-opacity"
            >
