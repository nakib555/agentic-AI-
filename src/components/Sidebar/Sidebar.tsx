    ...
    return (
        <aside className={`h-full z-20 ${isDesktop ? 'flex-shrink-0' : 'w-0'}`}>
            ...
            <motion.div
                ...
                className="bg-theme-bg-light dark:bg-[#121212] border-r border-gray-200/50 dark:border-white/10 flex flex-col transform-gpu" // Added transform-gpu to promote to its own layer
