...
export const NavItem = ({ icon, text, active, isCollapsed, isDesktop, onClick, disabled }: NavItemProps) => {
    ...
    const activeClasses = `bg-violet-200/50 dark:bg-violet-900/60 shadow-inner text-slate-900 font-semibold dark:text-slate-50`;
    const inactiveClasses = `bg-violet-100/30 dark:bg-violet-900/20 text-slate-600 dark:text-slate-300 shadow-sm border border-violet-200/50 dark:border-white/10`;
    const hoverClasses = `hover:shadow-md hover:border-violet-300/80 dark:hover:border-white/20 hover:bg-violet-100/80 dark:hover:bg-violet-900/40`;
