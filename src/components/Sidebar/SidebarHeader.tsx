  ...
  return (
    <div className={`flex items-center mb-6 h-10 ${shouldCollapse ? 'justify-center' : 'justify-between'}`}>
      <div className="relative group">
          <button 
              onClick={onNewChat}
              className={`w-full flex items-center gap-2 rounded-lg transition-colors text-left bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 ${shouldCollapse ? 'p-2.5 justify-center' : 'px-3 py-2'}`}
          >
