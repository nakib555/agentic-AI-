  ...
  >
      <div className="relative">
        <input 
          type="text" 
          placeholder="Search" 
          className="w-full pl-10 pr-16 py-2.5 bg-slate-200/50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-400 dark:focus:ring-teal-500"
          value={searchQuery}
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <kbd className="inline-flex items-center px-2 py-0.5 text-xs font-sans text-slate-500 bg-white/50 dark:bg-slate-700/50 border border-slate-300/70 dark:border-slate-600/70 rounded">
              Ctrl+K
            </kbd>
        </div>
      </div>
