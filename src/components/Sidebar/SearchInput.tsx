  ...
  >
      <div className="relative">
        <input 
          ...
          type="text" 
          placeholder="Search" 
          className="w-full pl-10 pr-16 py-2.5 bg-gray-100/60 dark:bg-black/20 border border-gray-200/50 dark:border-white/10 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500"
          value={searchQuery}
