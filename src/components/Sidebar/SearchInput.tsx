  ...
  >
      <div className="relative">
        <input 
          ...
          type="text" 
          placeholder="Search" 
          className="w-full pl-10 pr-16 py-2.5 bg-white dark:bg-zinc-800/50 border border-slate-300/70 dark:border-zinc-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500"
          value={searchQuery}
