  ...
  >
      <div className="relative">
        <input 
          ...
          type="text" 
          placeholder="Search" 
          className="w-full pl-10 pr-16 py-2.5 bg-violet-100/60 dark:bg-violet-900/30 border border-violet-200/50 dark:border-violet-500/20 rounded-2xl text-base focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500"
          value={searchQuery}
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <kbd className="inline-flex items-center px-2 py-0.5 text-sm font-sans text-slate-500 bg-white/50 dark:bg-black/20 border border-slate-300/70 dark:border-white/10 rounded">
              Ctrl+K
            </kbd>
        </div>
      </div>
