...
// FIX: Use the default express import and namespaced types to avoid global DOM type collisions.
...
// API routes
// FIX: Use namespaced express.Request and express.Response types to resolve type conflicts.
